...
export class EmployeeService {
  ...
  updateAddresslInfo(employeeId: string, addressInfo: EmployeeAddressInfo) {
    return this.httpClient.put(
      `${ApiPaths.HRMS}/employees/update/address/` + employeeId,
      addressInfo,
    );
  }
  ...
  updateReferenceInfo(employeeId: string, model: any) {
    return this.httpClient.patch(
      `${ApiPaths.HRMS}/employees/update/references/` + employeeId,
      model,
    );
  }
  updateEmploymentInfo(employeeId: string, model: any) {
    return this.httpClient.patch(
      `${ApiPaths.HRMS}/employees/update/employments/` + employeeId,
      model,
    );
  }
  updateQualificationsInfo(employeeId: string, model: any) {
    return this.httpClient.patch(
      `${ApiPaths.HRMS}/employees/update/qualifications/` + employeeId,
      model,
    );
  }
  updateBankingInfo(employeeId: string, model: any) {
    return this.httpClient.patch(
      `${ApiPaths.HRMS}/employees/update/banking-info/` + employeeId,
      model,
    );
  }
