  ...
  showSuccessAlert() {
    Swal.fire({
      html: `
        ...
        <p class="swal-text">Your data has been saved successfully.<br>You can view the details in the dashboard.</p>
  ...
  showInfoAlert() {
    Swal.fire({
      html: `
        ...
        <h2 class="swal-title">Information</h2>
        <p class="swal-text">This is some important information<br>you should know.</p>
		<svg viewBox="0 0 1440 320" class="btm-svg">
  ...
  showWarningAlert() {
    Swal.fire({
      html: `
        ...
        <p class="swal-text">Please review the information you've entered.<br>Some changes you made may not be saved.</p>
        <svg viewBox="0 0 1440 320" class="btm-svg">
