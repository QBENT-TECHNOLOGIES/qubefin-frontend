...
export const routes: Routes = [
    ...
    },
    {
        path: 'unauthorized',
        loadComponent: () =>
            import('./features/error/page-unauthorized/page-unauthorized').then(m => m.PageUnauthorized),
    },
    {
        path: '**',
        loadComponent: () => import('./features/error/page-notfound/page-notfound').then(m => m.PageNotfound),
    }
];
